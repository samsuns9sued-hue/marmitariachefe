...
import HeaderMeusPedidos from '@/components/HeaderMeusPedidos'
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-amber-50 to-gray-100">
      ...
      <header className="relative overflow-hidden flex flex-col">
        ...
        {/* CONTEÚDO PRINCIPAL */}
        <div className="relative z-10 px-4 pt-10 pb-4 flex-1 flex flex-col items-center">
          
          {/* Logo e Título (Lado a Lado) */}
          <div className="flex flex-row items-center justify-center gap-5 mb-4 mt-4">
